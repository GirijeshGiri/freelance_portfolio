      ...
      <div className="container-custom relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-6xl font-bold mb-8 leading-tight">
            Ready to Get <span className="text-gold">More Customers?</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
            ...
            <a
              ...
              className="w-full sm:w-auto bg-white text-navy px-10 py-5 rounded-2xl text-xl font-bold hover:scale-105 transition-all flex items-center justify-center shadow-xl"
            >
